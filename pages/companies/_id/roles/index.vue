      ...
      <section class="flex flex-col flex-wrap justify-between gap-6 md:items-center md:flex-row">
        ...
        <div class="flex items-center gap-4">
          ...
          <a href="#"
            ...
            <img src="/assets/svgs/ic-bell.svg"
                 alt="" />
          </a>
        </div>
      </section>
      ...
      <section class="pt-[50px]">
        ...
        <div class="mb-[30px]">
          <div class="flex flex-col justify-between gap-6 sm:items-center sm:flex-row">
            ...
            <NuxtLink :to="{ name: 'companies-id-roles-create' }"
                      class="btn btn-primary">New Role</NuxtLink>
          </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-[30px]"
          ...
          <div class="items-center card !flex-row gap-4"
            ...
            <img src="/assets/svgs/ric-flag.svg"
                 alt="" />
            <div>
              <div class="mb-1 font-semibold text-dark">{{ roles.name }}</div>
              <p class="text-grey">{{ roles?.employees_count }} people assigned</p>
            </div>
          </div>
